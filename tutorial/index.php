...
<?php include_once '../templates/main_menu.php'; ?>
    <div id="main_container" class="ui raised very padded text container segment" style="text-align: center">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/Uagzl801re4" frameborder="0" allowfullscreen></iframe>
    </div>
